...
export default function CouponsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      {/* Claim modal */}
      {selected && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center px-4 pb-16 sm:pb-0" onClick={() => setSelected(null)}>
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-y-auto" style={{ maxHeight: 'calc(85dvh - env(safe-area-inset-bottom, 0px))' }} onClick={e => e.stopPropagation()}>
