...
export default function LensWizard({ frameId, frameName, selectedColor = '', selectedSize = '', open, onClose }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-lg overflow-y-auto scrollbar-hide mb-16 sm:mb-0" style={{ maxHeight: 'calc(85dvh - env(safe-area-inset-bottom, 0px))', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
        <DialogHeader>
