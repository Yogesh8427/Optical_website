...
export default function HeroSlider() {
  ...
  if (!banners.length) {
    return (
      <div className="relative h-[280px] md:h-[520px] flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--theme-primary,#2563eb) 0%, color-mix(in srgb, var(--theme-primary,#2563eb) 55%,#000) 100%)' }}>
        {/* Floating orbs */}
        ...
        {/* Watermark */}
        <span className="pointer-events-none select-none absolute hidden md:block text-[8rem] md:text-[14rem] font-black text-white/5 leading-none">VISION</span>
        <div className="text-center text-white px-4 relative z-10">
          ...
          <h1 className="text-3xl md:text-7xl font-black mb-3 md:mb-5 leading-tight [text-shadow:0_2px_20px_rgba(0,0,0,0.4)]">See the World<br />Clearly</h1>
          <p className="text-sm md:text-lg text-white/70 mb-5 md:mb-8 max-w-md mx-auto">Premium eyewear, perfectly customized for you</p>
  ...
  return (
    <>
      ...
      <div className="relative h-[280px] md:h-[520px] overflow-hidden bg-gray-900 select-none">
        ...
        <div className={`absolute inset-0 z-20 ${animating ? enterClass : ''}`}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white px-6 max-w-3xl">
              ...
              <h1 key={`title-${current}`} className="animate-fade-up-delay text-2xl md:text-6xl font-black mb-3 md:mb-4 leading-tight drop-shadow-2xl [text-shadow:0_2px_20px_rgba(0,0,0,0.6)]">
