  ...
  return (
    <section className="py-6 md:py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex overflow-x-auto gap-4 pb-3 snap-x snap-mandatory [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-5 md:overflow-visible md:pb-0">
          {offers.map((offer, i) => (
            <motion.div
              key={offer._id}
